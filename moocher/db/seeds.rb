...
item1 = Item.create(name: 'Basketball', description: 'spalding basketball', image: '![](https://img.ssww.com/cs_srgb/q_90/w_312/v1536837115/3R/14/SWW8083R14.jpg)', condition: 'good', user: user1)
...
item11 = Item.create(name: "sword", description: "Black Water Bottle", image: '![](https://images.costco-static.com/ImageDelivery/imageService?profileId=12026540&imageId=100422284-847__1&recipeName=300)', condition: 'poor', user: user2)

item12 = Item.create(name: "Earrings", description: "Samurai Sword", image: '![](https://cdn.shopify.com/s/files/1/2234/4067/products/DSC01282_5b1ca12d-cc8f-4418-97e6-40300e13dd93_300x300.jpg?v=1527247736)', condition: 'fair', user: user2)
